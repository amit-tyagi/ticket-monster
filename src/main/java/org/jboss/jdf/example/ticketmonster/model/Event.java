 ...
 * 
 * <p>
 * Event's principle members are it's relationship to {@link org.jboss.jdf.example.ticketmonster.model.EventCategory} - specifying the type of event it is - and
 * {@link org.jboss.jdf.example.ticketmonster.model.MediaItem} - providing the ability to add media (such as a picture) to the event for display. It also contains
