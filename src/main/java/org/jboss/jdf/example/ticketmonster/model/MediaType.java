...
/**
 * <p>
 * The {@link org.jboss.jdf.example.ticketmonster.model.MediaType} describes the types of media this application can handle and render.
 * 
 * <p>
 ...
 * 
 * <p>
 * The {@link org.jboss.jdf.example.ticketmonster.model.MediaType} also describes whether this type of media can be cached locally, and used when there is no internet
